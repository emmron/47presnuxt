...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "9ceb573d-99a6-4fa6-bddf-fd15ecca5c46",
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/emmetthoolahan/47presnuxt/.data/kv"}));
...
const _lazy_t9vEfX = () => import('../routes/api/trump-stats.mjs');
const _lazy_TU8Stg = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/trump-stats', handler: _lazy_t9vEfX, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_TU8Stg, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_TU8Stg, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, handler as A, defineRenderHandler as a, getQuery as b, createError$1 as c, defineEventHandler as d, getRouteRules as e, getResponseStatus as f, getMethod as g, getResponseStatusText as h, useNitroApp as i, joinRelativeURL as j, defu as k, getContext as l, createHooks as m, hasProtocol as n, joinURL as o, parseQuery as p, isScriptProtocol as q, sanitizeStatusCode as r, setResponseHeaders as s, withTrailingSlash as t, useRuntimeConfig as u, withoutTrailingSlash as v, withQuery as w, toRouteMatcher as x, createRouter$1 as y, hash as z };
