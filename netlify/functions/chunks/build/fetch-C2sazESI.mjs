import { mergeProps, useSSRContext, computed, toValue, reactive, ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref } from 'vue';
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-white p-6 rounded-lg shadow-md" }, _attrs))}><h3 class="text-xl font-semibold mb-2">${ssrInterpolate(__props.title)}</h3><p class="${ssrRenderClass([__props.valueColor, "text-4xl font-bold"])}">${ssrInterpolate(__props.value)}</p><p class="text-gray-600 mt-2">${ssrInterpolate(__props.description)}</p>`);
      if (__props.source) {
        _push(`<p class="text-xs text-gray-500 mt-2">Source: ${ssrInterpolate(__props.source)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
//# sourceMappingURL=fetch-C2sazESI.mjs.map
