import { version, unref, inject, defineComponent, provide, shallowReactive, h, ref, watch, Suspense, nextTick, Fragment, Transition, hasInjectionContext, getCurrentInstance, resolveComponent, createApp, effectScope, reactive, getCurrentScope, computed, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, useSSRContext, toRef, mergeProps, withCtx, createTextVNode, defineAsyncComponent, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch, c as createError$1, k as defu, p as parseQuery, l as getContext, m as createHooks, n as hasProtocol, o as joinURL, q as isScriptProtocol, w as withQuery, r as sanitizeStatusCode, t as withTrailingSlash, v as withoutTrailingSlash, x as toRouteMatcher, y as createRouter$1 } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    ...
    component: () => import('./executive-orders--G7zkgqH.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-gUy3vBbl.mjs')
  }
];
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gray-100" }, _attrs))}><nav class="bg-blue-900 text-white"><div class="container mx-auto px-4"><div class="flex items-center justify-between h-16"><h1 class="text-2xl font-bold">Trump Presidency Statistics</h1><div class="hidden md:flex space-x-4">`);
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Executive Orders`);
          } else {
            return [
              createTextVNode("Executive Orders")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`Foreign Policy`);
          } else {
            return [
              createTextVNode("Foreign Policy")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</div></div></div></nav><main class="container mx-auto p-4">`);
      _push(ssrRenderComponent(_component_NuxtPage, null, null, _parent));
      _push(`</main><footer class="bg-gray-800 text-white py-4 mt-8"><div class="container mx-auto px-4 text-center"><p class="text-sm">Data sourced from official government records and reputable sources</p></div></footer></div>`);
    };
  }
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-Bvim5WHv.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Ci84TkKk.mjs'));
...
export { __nuxt_component_0 as _, asyncDataDefaults as a, createError as c, entry$1 as default, fetchDefaults as f, injectHead as i, resolveUnrefHeadInput as r, useNuxtApp as u };
